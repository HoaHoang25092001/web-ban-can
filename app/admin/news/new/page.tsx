...
import { ArrowLeft, FileText, Image as ImageIcon, Eye, EyeOff, Send, Save } from 'lucide-react';
...
export default function NewNewsPage() {
  ...
  const handleSubmit = async (published: boolean) => {
    ...
    if (!formData.content.trim() || formData.content === '<p></p>') {
      toast.error('Thiếu nội dung', 'Vui lòng nhập nội dung bài viết');
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        toast.success(
          ...
          published ? 'Bài viết đã được đăng lên website' : 'Bài viết đã được lưu nháp'
        );
      ...
      <div className="space-y-6 max-w-5xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Tạo bài viết mới để đăng lên website</p>
          </div>
        </div>
